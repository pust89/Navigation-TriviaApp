...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mBinding = DataBindingUtil.inflate<FragmentGameBinding>(
        ...
        mBinding.submitButton.setOnClickListener { view: View ->

            val checkedId = mBinding.questionRadioGroup.checkedRadioButtonId
            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        // We've won! Navigate to to the GameWonFragment.
                        //  Navigation without safeArgs
    ...
    // Sets the question and randomize the answers. This only change the data, not UI.
    ...
    private fun setQuestion() {
        ...
        mBinding.questionRadioGroup.clearCheck()
    }
